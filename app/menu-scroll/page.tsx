      ...
      headlines.forEach((elem, i) => {
        ...
        if (relevantContent) {
          smallTimeline
            .to(
              elem,
              { duration: 0.25, color: 'orange', scale: 1.25, ease: 'none' },
              0
            )
      ...
      <div className="wrapper">
        <div className={styles.pinUp}>
          <div className={styles.contentWrap}>
            <span className={`${styles.content} content-0 ${styles.initial}`}>
              Greensock
            </span>
            ...
            <span className={`${styles.content} content-4 ${styles.remaining}`}>
              Awesomeness
            </span>
          </div>
